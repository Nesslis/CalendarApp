...
const AppLocaleContext = createContext<AppLocaleContext>({} as AppLocaleContext);
...
const AppLocaleProvider = ({ children }: { children: React.ReactNode }) => {
  ...
  return <AppLocaleContext.Provider value={{ handleChangeLocale }}>{children}</AppLocaleContext.Provider>;
};
